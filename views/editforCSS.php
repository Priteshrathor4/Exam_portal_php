...
<body>
    <script>
        ...
        function showUpdate(question, opp1, opp2, opp3, opp4, ansU, id) {
            ...
            document.getElementById('update_CSS').action = `updatecss.php?id=${id}`;
            console.log(id);
        }
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                            ...
                            <div class="card" style="height: auto;">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <h1 style="text-align: center; color: rgb(86, 145, 255);"> CSS</h1>
                                        ...
                                        <table class="table" id="table-id">
                                            ...
                                            <tbody>
                                                ...
                                                $stmt = $db->query("SELECT * from qcss ORDER BY id ASC");
                                                ...
                                                <?php while ($row = $stmt->fetch(PDO::FETCH_NUM)) {   ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <form action="deletecss.php" method="POST">
                                                            <td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" style="padding:40px 50px;">
                                                                        <form role="form" name="update_CSS" id="update_CSS" method="post" onsubmit="return store1()">
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="from-group">
                                                                                <input type="text" placeholder="A" id="o11" name="op1">
                                                                            </div>
                                                                            <br>
                                                                            <div class="from-group">
                                                                                <input type="text" name="op2" id="o21" placeholder="B">
                                                                            </div> <br>
                                                                            <div class="from-group">
                                                                                <input type="text" name="op3" id="o31" placeholder="C">
                                                                            </div> <br>
                                                                            <div class="from-group">
                                                                                <input type="text" name="op4" id="o41" placeholder="D">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <br>
              ...
              </div> --><span id="est1" style="font-size: larger; color: red;"></span>
                                                                            <br>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="padding:40px 50px;">
                                                                            <form role="form" method="GET" onsubmit="return store()">
                                                                                <div class="form-group">
                                                                                    <!-- <label for="usrname"><span class="glyphicon glyphicon-user"></span> <b>Update Question</b></label> -->
                                                                                    <input type="text" class="form-control" name="qucss" id="q1" placeholder="Q-1">

                                                                                </div>
                                                                                <br>
                                                                                <div class="from-group">
                                                                                    <input type="text" name="op1css" placeholder="A" id="o1">
                                                                                </div>
                                                                                <br>
                                                                                <div class="from-group">
                                                                                    <input type="text" name="op2css" id="o2" placeholder="B">
                                                                                </div> <br>
                                                                                <div class="from-group">
                                                                                    <input type="text" name="op3css" id="o3" placeholder="C">
                                                                                </div> <br>
                                                                                <div class="from-group">
                                                                                    <input type="text" name="op4css" id="o4" placeholder="D  ">
                                                                                </div> <br>
                                                                                <div class="form-group">
                                                                        ...
                                                                        if (isset($_GET['submitN'])) {
                                                                            ...
                                                                            $opfour = $_GET['op4css'];
                                                                            $ans = $_GET['ans'];
                                                                            $sql = "select *from qcss where question = '$qu'";
                                                                            $stmt = $db->prepare($sql);
                                                                            $stmt->execute();
                                                                            $check = $stmt->rowCount();
                                                                            ...
                                                                            if ($check > 0) {
                                                                                ...
                                                                                $sql2 = "INSERT INTO qcss(question, op1, op2, op3, op4, ans)
                                                                        ...
                                                                        ?>
                                                                                    <script>
                                                                                        window.location.href = "http://localhost/Project2/views/editforCSS.php";
                                                                                    </script>
                                                                        <?php
                                                                                } else {
