...
$id = $_SESSION['id'];
echo $id;
$query = "SELECT * FROM public.qcss  ORDER BY id ASC Limit 25";
...
if($num==0){
    ...
    $queryR = "INSERT INTO public.result (name, email, scorecss, correctanscss, incorrectanscss,sid) VALUES ('$name','$email','$marks','$marks','$incorrect','$id')";
    ...
    $queryRU = "UPDATE public.result SET scorecss='$marks',correctanscss='$marks',  incorrectanscss='$incorrect' , css_date=CURRENT_DATE, css_time=CURRENT_TIME WHERE sid=$id ";
