...
<body>
    ...
    <script>
        ...
        function showUpdate(id, name, email, username, password, qua) {
            $('#myModal').modal('show');
            $("#name1").val(name);
            $("#email1").val(email);
            $("#unm1").val(username);
            ...
            document.getElementById('update_user').action = '/userUpdate/' + id
        }
                        ...
                        <div>
                            <div class="card" style="height: auto; ">
                                ...
                                <div class="form-group">
                                    <label for="" style="float: left;padding-top: 10px;">Select No. of Rows :
                                        &emsp;</label>
                                    <select class="form-control" name="state" id="maxRows"
                                        style="width: fit-content; border: 7 ;">
                                    ...
                                    <div>
                                        <table class="table" id="table-id">
                                            <thead class="bg-light">
                                                <tr style="background-color: rgb(86, 145, 255);" class="border-0">
                                                    <th class="border-0"> <b> Id</b></th>
                                                    <th class="border-0"> <b> Student Name</b></th>
                                                    <th class="border-0"><b>Email</b></th>
                                                    <td class="border-0" style="color: black;"><b> Result</b></td>
                                                    <th class="border-0" style="color: black;"><b> Correct</b></th>
                                                    <th class="border-0" style="color: black;"><b> incorrect</b></th>
                                                    <th class="border-0" style="color: black;"><b> Date</b></th>
                                                    <th class="border-0" style="color: black;"><b> Time</b></th>
