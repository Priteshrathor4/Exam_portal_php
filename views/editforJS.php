...
<body>
    <script>
        ...
        function showUpdate(question, opp1, opp2, opp3, opp4, ansU, id) {
            ...
            document.getElementById('update_js').action = `updatejs.php?id=${id}`;
            console.log(id);
        }
        ...
        store = () => {
            ...
            let o3 = $('#o3').val();
            let o4 = $('#o4').val();
            let ansU = $('#ansA').prop('selected', true).val();
            // let Number = /^[0-9]+$/;
            // let letter = /^[ a-zA-Z]+$/;
        ...
        store1 = () => {
            ...
            let o3 = $('#o31').val();
            let o4 = $('#o41').val();
            // let ansU = $('#ansU').is('selected', true);
            let ansA = $('#ansU').prop('selected', true).val();
            // ansU.val(ansU);
            // let Number = /^[0-9]+$/;
            // let letter = /^[ a-zA-Z]+$/;
            // let mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="/editforJS">Quiz Portal</a>
                        ...
                        <div>
                            <div class="card" style="height: auto;">
                                ...
                                <div class="card-body p-0">
                                    <div>
                                        <h1 style="text-align: center; color: rgb(86, 145, 255);"> JAVASCRIPT</h1>
                                        ...
                                        <table class="table" id="table-id">
                                            <thead class="bg-lightfor">
                                                <tr class="border-0">
                                                    ...
                                                    <th class="border-0">OPTION A</th>
                                                    <th class="border-0">OPTION B</th>
                                                    <th class="border-0">OPTION C</th>
                                                    <th class="border-0">OPTION D</th>
                                            ...
                                            <tbody>
                                                ...
                                                $stmt = $db->query("SELECT * from javascript ORDER BY id ASC");
                                                ...
                                                <?php while ($row = $stmt->fetch(PDO::FETCH_NUM)) {   ?>
                                                    <tr>
                                                        ...
                                                        <form action="deletejs.php" method="POST">
                                                            <td>
                                                                <input type="hidden" name="id" value="<?php echo $row[5]; ?>">
                                                                <button class="btn btn-danger rounded-sm" style="border-radius: 10px;" data-toggle="modal" data-target="#exampleModal">DELETE</button>
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" style="padding:40px 50px;">
                                                                        <form role="form" method="post" name="update_js" id="update_js" onsubmit="return store1()">
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="from-group">
                                                                                <input type="text" placeholder="option-A" name="op1" id="o11">
                                                                            </div>
                                                                            <br>
                                                                            <div class="from-group">
                                                                     ...
                                                                     <div class="checkbox">
                                                                        <label><input type="checkbox" value="" checked>Remember me</label>
                                                                            ...
                                                                            <br>
                                                                            <button type="submit" name="submitN" class="btn btn-success btn-block" style="background-color: #3d405c;"><span class="glyphicon glyphicon-off"></span>Save
                                                                                Change</button>
                                                        ...
                                                        <div class="modal fade" id="myModal" role="dialog">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" style="padding:40px 50px;">
                                                                        <form role="form" method="GET" onsubmit="return store()">
                                                                            <div class="form-group">
                                                                                <!-- <label for="usrname"><span class="glyphicon glyphicon-user"></span> <b>Update Question</b></label> -->
                                                                                <input type="text" class="form-control" id="q1" name="question" placeholder="Q">

                                                                            </div>
                                                                            <br>
                                                                            <div class="from-group">
                                                                                <input type="text" placeholder="option-A" name="op1" id="o1">
                                                                            </div>
                                                                            <br>
                                                                            <div class="from-group">
                                                                                <input type="text" name="op2" id="o2" placeholder="option-B">
                                                                            </div> <br>
                                                                            <div class="from-group">
                                                                                <input type="text" name="op3" id="o3" placeholder="option-C">
                                                                            </div> <br>
                                                                            <div class="from-group">
                                                                                <input type="text" name="op4" id="o4" placeholder="option-D">
                                                                            </div> <br>
                                                                            <div class="form-group">
                                                                                <select style="width: 170px; height: 35px; color: #71728e;border-color: #3d405c;" name="ans" id="ansA">
                                                                                    <option value="">
                                                                                        Select Answer
                                                                                    </option>
                                                                                    <option value="A">A
                                                                            ...
                                                                            <br>
                                                                            <button type="submit" name="submitN" class="btn btn-success btn-block" style="background-color: #3d405c;"><span class="glyphicon glyphicon-off"></span>Add
                                                                                Question</button>
                                                                            <button type="reset" class="btn btn-success btn-block" style="background-color: #3d405c;"><span class="glyphicon glyphicon-off"></span>Reset</button>
                                                                        </form>
                                                                    </div>
                                                                    ...
                                                                    if (isset($_GET['submitN'])) {
                                                                        ...
                                                                        $sql = "select *from javascript where question = '$qu'";
                                                                        $stmt = $db->prepare($sql);
                                                                            $stmt->execute();
                                                                            $check= $stmt->rowCount();
                                                                        ...
                                                                        if ($check > 0) {
                                                                            echo '<script>alert("quastion already exist!")</script>';
                                                                        } else {
                                                                            $qua = "INSERT INTO javascript(question, op1, op2, op3, op4, ans)
                                                                    ...
                                                                    ?>
                                                                                <script>
                                                                                    window.location.href = 'http://localhost/Project2/views/editforJS.php';
                                                                                </script>
                                                                    <?php
                                                                            } else {
