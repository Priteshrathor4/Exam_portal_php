                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/img.png" alt="" class="user-avatar-md rounded-circle"></a>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Students No. appeared in Quiz</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">40</h1>
                                        </div>
                                        <div class="iconBx">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Pass Students</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">35</h1>
                                        </div>
                                        <div class="iconBx">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Fail Students</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">5</h1>
                                        </div>
                                        <div class="iconBx">
                        ...
                        <div class="row">
                            ...
                            <div class="signup-image">
                                <figure><img src="./signup-image.jpg" style="width: 200%;height:10%;" alt="sing up image"></figure>
