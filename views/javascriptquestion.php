...
$sql = "SELECT * from javascript ORDER BY id ASC";
$stmt = $db->prepare($sql);
$stmt->execute();
// $res = pg_query($db, $sql);
...
<body>
        ...
        <div id="fh5co-wrapper">
            <div id="fh5co-page">
                <div class="container myclass" id="screen"
                    ...
                    <form id="exitForm" name="exitForm" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="js" value="JS"/ hidden>
    ...
    <script>
        ...
        $('#exit').click(() => {
            document.getElementById('exitForm').action = './submitjs.php'
            return true;
        })
