...
$id = $_SESSION['id'];
echo $id;
$query = "SELECT * FROM public.qhtml  ORDER BY id ASC Limit 25";
...
if($num==0){
    ...
    $queryR = "INSERT INTO public.result (name, email, scorehtml, correctanshtml, incorrectanshtml,sid) VALUES ('$name','$email','$marks','$marks','$incorrect','$id')";
    ...
    $queryRU = "UPDATE public.result SET scorehtml='$marks',correctanshtml='$marks',  incorrectanshtml='$incorrect' , subb_date=CURRENT_DATE, subb_time=CURRENT_TIME WHERE sid=$id ";
