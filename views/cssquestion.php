...
// echo $_SESSION['sub'];
$sql = "SELECT * from qcss ORDER BY id ASC";
$stmt = $db->prepare($sql);
$stmt->execute();
// $res = pg_query($db, $sql);
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <center>
                            ...
                            <button type="submit" id="start" class="button-34"
                                style="width:300px;height:40px;font-size: 20px;"><b>Attempt
                                    Exam Now</b></button>
                        </center>
                    </div>
                </div>
    ...
    <div id="front" class="main" style="display: none;">

        <div id="fh5co-wrapper">
            <div id="fh5co-page">
                <div class="container myclass" id="screen"
                    style="background-color: linear-gradient(to right, #d9ecf8,#f0c7ed ,#a0b1f0);">
                    <div class="col-lg-12">
                        <p class="h1"
                            style="text-align: end; justify-content: center; color:  linear-gradient(to right, #d9ecf8,#f0c7ed ,#a0b1f0); ">
                            QUIZ</p>
                    </div>
                    <div class="col-lg-12">
                        <div class="h1" id="count"
                            style="text-align: end; justify-content: center; color:  linear-gradient(to right, #d9ecf8,#f0c7ed ,#a0b1f0); ">
                        </div>
                    </div>
                    <form id="exitForm" name="exitForm"  method="POST" action="submitcss.php">
                        <table id="mytable" style="padding-left: 200px;">
                            <h1 style="text-align: center;">CSS QUIZ</h1>
                            <tr></tr>
                            <?php $i = 1; ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="css" value="CSS"/ hidden>
                                    <button class="btn btn-warning " type="submit" id="exit"
                                        style="border-radius: 10px;font-size: 30px;float:right;color:red;margin-right: 100px;">Exit</button>
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination pagination-lg" id="pgnext">
                                            <li data-page="next" id="prev" onclick="pgnext()">
                                                <span class="btn  btn-info " style="float: left;font-weight: bold;">Next
                                                    -> </span>
                                            </li>
                                        </ul>
                                    </nav>
    ...
    <script>
        ...
        $('#exit').click(() => {
            document.getElementById('exitForm').action = './submitcss.php'
            return true;
        })
